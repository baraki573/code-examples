<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false>
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="${url.resourcesPath}/img/favicon_32.png"/>
        ...
        <script src="https://kit.fontawesome.com/64792b9c60.js" crossorigin="anonymous"></script>
    </head>
    ...
    <div class="${properties.kcLoginClass!}">
        ...
        <div class="${properties.kcFormCardClass!} dark-card">
