...
class Favorite extends DataClass implements Insertable<Favorite> {
  ...
  factory Favorite.fromData(Map<String, dynamic> data, GeneratedDatabase db,
    ...
    return Favorite(
      ...
      currentEp:
          intType.mapFromDatabaseResponse(data['${effectivePrefix}current_ep']),
      genre:
          stringType.mapFromDatabaseResponse(data['${effectivePrefix}genre']),
      epNum:
          stringType.mapFromDatabaseResponse(data['${effectivePrefix}ep_num']),
      fsk: intType.mapFromDatabaseResponse(data['${effectivePrefix}fsk']),
      prodYear:
          intType.mapFromDatabaseResponse(data['${effectivePrefix}prod_year']),
      addDate: $FavoritesTable.$converter0.mapToDart(stringType
          .mapFromDatabaseResponse(data['${effectivePrefix}add_date'])),
      watchDate: $FavoritesTable.$converter1.mapToDart(stringType
          .mapFromDatabaseResponse(data['${effectivePrefix}watch_date'])),
      marked: intType.mapFromDatabaseResponse(data['${effectivePrefix}marked']),
    );
  }
  @override
...
class $FavoritesTable extends Favorites
  ...
  GeneratedIntColumn _currentEp;
  @override
  GeneratedIntColumn get currentEp => _currentEp ??= _constructCurrentEp();
  GeneratedIntColumn _constructCurrentEp() {
    return GeneratedIntColumn(
      'current_ep',
      $tableName,
      false,
  ...
  GeneratedTextColumn _epNum;
  @override
  GeneratedTextColumn get epNum => _epNum ??= _constructEpNum();
  GeneratedTextColumn _constructEpNum() {
    return GeneratedTextColumn(
      'ep_num',
      $tableName,
      false,
  ...
  GeneratedIntColumn _fsk;
  @override
  GeneratedIntColumn get fsk => _fsk ??= _constructFsk();
  GeneratedIntColumn _constructFsk() {
    return GeneratedIntColumn(
      'fsk',
      $tableName,
      false,
  ...
  GeneratedIntColumn _prodYear;
  @override
  GeneratedIntColumn get prodYear => _prodYear ??= _constructProdYear();
  GeneratedIntColumn _constructProdYear() {
    return GeneratedIntColumn(
      'prod_year',
      $tableName,
      false,
  ...
  GeneratedTextColumn _addDate;
  @override
  GeneratedTextColumn get addDate => _addDate ??= _constructAddDate();
  GeneratedTextColumn _constructAddDate() {
    return GeneratedTextColumn(
      'add_date',
      $tableName,
      false,
  ...
  GeneratedTextColumn _watchDate;
  @override
  GeneratedTextColumn get watchDate => _watchDate ??= _constructWatchDate();
  GeneratedTextColumn _constructWatchDate() {
    return GeneratedTextColumn('watch_date', $tableName, false,
        defaultValue: Constant("01.01.2020 10:00:00"));
  }

  final VerificationMeta _markedMeta = const VerificationMeta('marked');
  GeneratedIntColumn _marked;
  @override
  GeneratedIntColumn get marked => _marked ??= _constructMarked();
  GeneratedIntColumn _constructMarked() {
    return GeneratedIntColumn('marked', $tableName, false,
